...
@Entity @Table(name = "training_records", indexes = @Index(name = "idx_training_records_school_id", columnList = "school_id")) @Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
