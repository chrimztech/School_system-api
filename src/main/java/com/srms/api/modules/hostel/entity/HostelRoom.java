...
@Entity @Table(name = "hostel_rooms", indexes = @Index(name = "idx_hostel_rooms_school_id", columnList = "school_id")) @Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
