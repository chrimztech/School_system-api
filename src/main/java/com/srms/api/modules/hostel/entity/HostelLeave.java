...
@Entity @Table(name = "hostel_leaves", indexes = @Index(name = "idx_hostel_leaves_school_id", columnList = "school_id")) @Getter @Setter @NoArgsConstructor @AllArgsConstructor @Builder
