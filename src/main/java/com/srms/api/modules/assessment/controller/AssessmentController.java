...
public class AssessmentController {
    ...
    @DeleteMapping("/{id}") public ResponseEntity<ApiResponse<Void>> delete(@PathVariable String schoolId, @PathVariable String id, Authentication auth) { assessmentService.delete(id, schoolId, auth.getName(), roleOf(auth)); return ResponseEntity.ok(ApiResponse.ok("Deleted", null)); }
